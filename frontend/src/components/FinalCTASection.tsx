import { Mail, Shield, Clock, Star, Users } from "lucide-react";
...
export default function FinalCTASection() {
  return (
    <section className="section-finland-blue py-20 lg:py-28 relative overflow-hidden">
      ...
      {/* Glow effect */}
      <div className="absolute inset-0 glow-finland opacity-30 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-white/80 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
          Book a free 15-minute launch readiness call. We'll review your product,
          identify the biggest quality risks, and recommend the right QA approach —
          no strings attached.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {trustPills.map((pill) => {
            ...
            return (
              ...
              >
                <Icon className="w-4 h-4 text-finland-blue-mid" />
                {pill.label}
              </div>
            );
          })}
