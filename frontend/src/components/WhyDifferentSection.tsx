import { Zap, Target, Shield, Clock, TrendingUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {differentiators.map((item) => {
            ...
            return (
              ...
              >
                {/* Background number */}
                <span className="absolute top-4 right-4 text-6xl font-bold font-heading text-finland-blue/8 select-none leading-none">
                  {item.number}
                </span>
