...
const useCases = [
  {
    ...
    description:
      "Checkout flows, cart logic, and payment integrations tested before go-live.",
  },
  {
    icon: CreditCard,
    title: "Fintech Products",
    description:
      "Transaction accuracy, security flows, and compliance-critical paths verified.",
  },
  {
    icon: Smartphone,
    title: "Mobile Apps",
    description:
      "Cross-device testing for iOS and Android to ensure consistent UX.",
  },
  {
    icon: Globe,
    title: "SaaS Platforms",
    description:
      "Multi-tenant logic, subscription flows, and API integrations validated.",
  },
  {
    icon: Users,
    title: "Marketplace Products",
    description:
      "Buyer/seller flows, search, and listing logic tested end-to-end.",
  },
  {
    icon: Layers,
    title: "API-First Products",
    description:
      "REST and GraphQL API testing with contract validation and edge cases.",
  },
];
  ...
  return (
    <section id="use-cases" className="section-white py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Use case cards */}
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 list-none">
